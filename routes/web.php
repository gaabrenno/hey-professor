...
Route::post('/question/like/{questionId}', Question\LikeController::class)->name('question.like');
Route::post('/question/unlike/{questionId}', Question\UnLikeController::class)->name('question.unlike');
