<nav x-data="{ open: false }" class="fixed top-0 left-0 w-full bg-gray-900 bg-opacity-90 shadow-md py-4 z-50">
    <!-- Primary Navigation Menu -->
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                <!-- Logo -->
                <a href="" class="self-center text-2xl font-bold text-blue-400 hover:text-blue-300 transition">RAG System</a>
